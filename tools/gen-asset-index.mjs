...
// lib/ is grouped into category folders (mirroring used/), each holding one
// folder per item. A few leaf categories such as ui may contain files directly.
const libCats = fs.readdirSync('lib', { withFileTypes: true })
