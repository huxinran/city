// Rebuild the generated corner-Wang blend sets of one or more cities from
// their current surface tiles:  node tools/rebuild-city-blends.mjs solara [...]
// Optionally limit the sets:    node tools/rebuild-city-blends.mjs solara --sets=grass-sand,dirt-grass
//
// NOTE: anrelia's sand-sea set is hand-crafted art, not generator output —
// don't rebuild it with this tool (and jinlin/columbia carry copies of it).
// Blend logic ported from tools/build-themed-map-tiles-from-imagegen.mjs.
...
const SEAMS = {
  anrelia: { color: [238, 218, 170, 255], base: 0.18, mul: 2.3 },
...
for (const city of cities) {
  ...
  for (const set of sets) {
    ...
    console.log(`rebuilt ${city}/blend/${set}`);
  }
}
console.log('done');
