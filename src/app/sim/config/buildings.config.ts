...
export const BUILDING_DEFS: Partial<Record<BuildingType, BuildingDef>> = {
    ...
    [BuildingType.BRICKYARD]:   { size: 2, material: [I(Resource.STONE_BLOCKS, 20)], icon: '🏭', productIcon: '🧱', recipe: { workers: 10, worker_type: Resident.WORKER, efficiency: 10, in: [I(Resource.CLAY)], out: [I(Resource.BRICK)], coal: true } },
