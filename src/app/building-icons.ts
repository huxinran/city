...
const BUILDING_IMAGE_SLUGS: { [key: string]: string } = {
    ...
    [BuildingType.POLICE_STATION]:        'police-station-v2',
...
const BUILDING_PRODUCT_ICONS: { [key: string]: string } = {
    ...
    [BuildingType.CHICKEN_COOP]: 'egg-basket-v2.png',
    ...
    [BuildingType.POTTERY_SHOP]: 'pottery-household-v2.png',
    ...
    [BuildingType.WINERY]: 'wine-barrel-v3.png',
    [BuildingType.OIL_PRESS]: 'olive-oil-jug-v3.png',
